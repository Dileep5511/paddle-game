...
var BACKGROUND_COLOR = makeColor(0.1, 0.2, 0.3, 0.6);

var PADDLE_SPEED     = 1200; // pixels per second
var PADDLE_COLOR     = makeColor(0.2, 1.0, 1.5);

var BALL_COLOR       = makeColor(1.0, 0.8, 0.4);
